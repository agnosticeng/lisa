// Flattened MLX NAX attention header closure (AOT for `sdpa_full_nax`).
// Auto-generated flattened MLX Metal header closure. Do not hand-edit;
// regenerate from the pinned MLX headers.
