// binary kernel (src/metal_src/binary.metal from the kernels crate
// 0.11.0, MIT/Apache-2.0). Vendored verbatim so the native runtime can
// dispatch it directly. See NOTICE.
